...
def build_widgets() -> list[WidgetDefinition]:
    return [
        ...
        WidgetDefinition(
            "parameter-fitter",
            "evaluate",
            i18n.t("Parameter Fitter"),
            True,
            _placeholder_factory("Parameter Fitter", "Not implemented yet."),
            i18n.t("Fit model parameters."),
            "info",
            _inputs("Data"),
            (),
        ),
        WidgetDefinition(
            ...
            i18n.t("Predictions"),
            True,
            _placeholder_factory("Predictions", "Not implemented yet."),
            i18n.t("Show model predictions on data."),
            "score",
            _inputs("Data", "Predictors"),
            _outputs("Predictions"),
        ),
        WidgetDefinition(
            "feature-as-predictor",
            "evaluate",
            i18n.t("Feature as Predictor"),
            True,
            _placeholder_factory("Feature as Predictor", "Not implemented yet."),
            i18n.t("Evaluate single features as predictors."),
            "score",
            _inputs("Data"),
            (),
        ),
        ...
        WidgetDefinition(
            ...
            i18n.t("Associate"),
            True,
            _placeholder_factory("Associate", "Not implemented yet."),
            i18n.t("Discover association rules in data."),
            "info",
            _inputs("Data"),
            (),
        ),
