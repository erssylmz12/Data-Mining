...
WORKFLOW_PORT_COMPATIBILITY_OVERRIDES = {
    ...
    ("Tree", "Model"): frozenset({"save-model", "stacking", "confusion-matrix", "roc", "performance-curve", "calibration-plot", "permutation-plot"}),
    ("Classifier", "Model"): frozenset({"save-model", "stacking", "confusion-matrix", "roc", "performance-curve", "calibration-plot", "permutation-plot"}),
    ("Random Forest", "Model"): frozenset({"save-model", "stacking", "confusion-matrix", "roc", "performance-curve", "calibration-plot", "permutation-plot"}),
